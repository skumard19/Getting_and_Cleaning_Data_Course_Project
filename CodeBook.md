...
The collection of the source data and the transformations listed above were implemented by the `Getting_and_Cleaning_Data_Project1.R` R script (see `README.md` file for usage instructions).
